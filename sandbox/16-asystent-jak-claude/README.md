# 16 - Asystent jak Claude (capstone)
...
```bash
# z katalogu sandbox/
uv run 16-asystent-jak-claude/main.py     # scenariusz na żywo (model z obsługą narzędzi)
uv run pytest 16-asystent-jak-claude/      # smoke test offline (TestModel)
```
