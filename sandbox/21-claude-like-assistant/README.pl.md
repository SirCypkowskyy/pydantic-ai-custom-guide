# 21 - Asystent jak Claude (capstone)
...
```bash
# z katalogu sandbox/
uv run 21-claude-like-assistant/main.py     # scenariusz na żywo (model z obsługą narzędzi)
uv run pytest 21-claude-like-assistant/      # smoke test offline (TestModel)
```
