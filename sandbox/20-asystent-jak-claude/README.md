# 20 - An assistant like Claude (capstone)
...
uv run 20-asystent-jak-claude/main.py     # live scenario (model with tool support)
uv run pytest 20-asystent-jak-claude/      # offline smoke test (TestModel)
```
