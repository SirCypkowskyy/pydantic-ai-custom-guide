...
function IconComponent({ size, ...props }: PartyPopperProps) {
  ...
  return (
    ...
    >
      ...
      <motion.path d="M4 3h.01" variants={variants.path3} initial="initial" animate={controls} />
      <motion.path d="M22 8h.01" variants={variants.path4} initial="initial" animate={controls} />
      <motion.path d="M15 2h.01" variants={variants.path5} initial="initial" animate={controls} />
      <motion.path d="M22 20h.01" variants={variants.path6} initial="initial" animate={controls} />
      <motion.path
